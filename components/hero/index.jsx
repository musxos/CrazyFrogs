const Hero = () => (
    <div className="w-auto mx-6 min-h-screen flex flex-col justify-center text-white lg:mx-[80px]">
        <div className="flex flex-col gap-6 h-[37.5rem] my-auto w-full align-middle lg:flex-row-reverse lg:align-middle lg:h-min lg:max-w-5xl lg:mx-auto lg:justify-between">
            ...
            <div className="contents lg:flex lg:flex-col lg:gap-4 lg:width-[700px]">
                <img src="/hero-text.svg" class="h-8 lg:hidden" />
                <img src="/hero-text-large.svg" class="hidden h-24 lg:block self-start" />
                <p className="w-96 text-center mx-auto text-xs lg:text-left lg:w-[26rem] lg:mx-0 opacity-50 lg:leading-6 leading-5">
                ...
                <img src="/hero-button.svg" class="h-16 lg:hidden" />
                <div className="w-96 mx-auto lg:mx-0 lg:w-auto">
                    <p className="text-left w-full text-sm mb-2 lg:text-center opacity-50">
                        AVAILABLE AT
                    </p>
                    <div className="w-full flex justify-between lg:gap-4">
                    <img src="/hero-button-large.svg" class="h-12 lg:block hidden" />
